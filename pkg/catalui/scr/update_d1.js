...
if (eDBDIR === 'd2') {
	...
	await degit_and_update('https://github.com/charlyoleg2/maker_parame78', 'rob', vDBDIR);
	await degit_and_update('https://github.com/charlyoleg2/maker_parame77', 'mishka', vDBDIR);
	await degit_and_update('https://github.com/charlyoleg2/maker_parame76', 'makeda', vDBDIR);
	await degit_and_update('https://github.com/charlyoleg2/maker_parame75', 'zenobie', vDBDIR);
